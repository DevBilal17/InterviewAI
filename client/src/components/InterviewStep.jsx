...
useEffect(()=>{
  ...
  const finishInterview = async () => {
    ...
    setIsMicOn(false);
    try {
      const response = await axios.post(`${SERVER_URL}/api/interview/finish`,{
        interviewId
      },{withCredentials:true})
    ...
    <div className="min-h-screen bg-linear-to-br from-emerald-50 via-white to-teal-100 flex items-center justify-center p-4 sm:p-6">
      <div className="w-full max-w-350 min-h-[80vh] bg-white rounded-3xl shadow-2xl border border-gray-200 flex flex-col lg:flex-row overflow-hidden">
        ...
        <div className="flex flex-col flex-1 p-4 sm:p-6 md:p-8 relative">
          ...
          {!isIntroPhase && (
            <div
              className="relative mb-6 bg-gray-50 p-4
          sm:p-6 rounded-2xl border border-gray-200 shadow-sm
          "
            >
          ...
          {!feedback ? (
            <div className="flex items-center gap-4 mt-6">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.9 }}
                className="flex-1 bg-linear-to-br from-emerald-600 to-teal-500 text-white py-3 sm:py-4 rounded-2xl shadow-lg hover:opacity-90 transition font-semibold
