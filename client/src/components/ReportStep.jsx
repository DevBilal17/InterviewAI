                ...
                <div key={i} className="bg-gray-50 p-4 sm:p-6 rounded-xl sm:rounded-2xl border border-gray-200">
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3 mb-4 ">
                    <div>
                      ...
                      <p className="font-semibold text-gray-800 text-sm sm:text-base leading-relaxed flex-wrap">
                        {q.question || "Question not available"}
                      </p>
                    </div>
                    <div className="bg-green-100 text-green-600 px-3 py-1 rounded-full font-semibold text-xs sm:text-sm w-fit">
                      {q.score ?? 0}/10
                    </div>
                  </div>
