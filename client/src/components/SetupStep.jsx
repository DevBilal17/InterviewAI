...
function SetupStep({ onStart }) {
  ...
  return (
    <motion.div
      ...
      className="min-h-screen flex items-center justify-center bg-linear-to-br from-gray-100 to-gray-200 px-4 py-10"
    >
                    ...
                    skills.length > 0 && (
                      ...
                      <div className="flex flex-wrap gap-2">
                        {skills.map((skill,index)=>{
                          return <span className="bg-green-100 text-green-700 px-3 py-1 rounded-full text-sm" key={index}>{skill}</span>
                        })}
                      </div>
                      </div>
                    )
